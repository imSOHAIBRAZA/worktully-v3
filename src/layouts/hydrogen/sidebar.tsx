                    ...
                    {item?.dropdownItems ? (
                      ...
                      className={cn(
                        ...
                        isActive
                          ...
                          : 'text-gray-500 transition-colors duration-200 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-700/90'
                      )}
                    >
                            ...
                            <span
                              className={cn(
                                ...
                                isActive
                                  ...
                                  : "text-gray-500 dark:text-gray-500 hover:text-gray-900 dark:group-hover:text-gray-700"
                              )}
                            >
                              {item?.icon}
                            </span>
